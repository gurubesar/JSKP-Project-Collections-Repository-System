        ...
        <section class="main-content">
            <div class="empty-state" style="min-height: 400px;">
                <div style="text-align: center;">
                    <i class="bi bi-cash-coin" style="font-size: 64px; color: var(--admin-gold); margin-bottom: 24px;"></i>
                    <h2 style="color: var(--admin-sidebar); margin-bottom: 12px;">Finance Management</h2>
                    <p style="color: var(--admin-muted); margin-bottom: 24px;">This feature is coming soon. Stay tuned!</p>
                    <p style="color: #999; font-size: 0.9rem;">Track and manage financial transactions and budgets.</p>
                </div>
            </div>
        </section>
    </main>
