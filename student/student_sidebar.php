<aside class="sidebar">
    ...
    <nav class="sidebar-nav" aria-label="Student navigation">
        ...
        <a class="sidebar-link<?= $currentPage === 'student_posters.php' ? ' active' : '' ?>" href="student_posters.php"><i class="bi bi-file-earmark-richtext-fill"></i><span>Project Posters</span></a>
        <a class="sidebar-link<?= $currentPage === 'student_feedback.php' ? ' active' : '' ?>" href="student_feedback.php"><i class="bi bi-chat-dots-fill"></i><span>Feedback</span></a>
    </nav>
</aside>
